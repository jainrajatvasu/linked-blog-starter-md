---
<<<<<<< HEAD
title: "The Easiest Way to Setup Obsidian Git"
=======
...
3. Create a [personal access token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token#creating-a-personal-access-token-classic) from github (Set scopes to `repo` & expiration to `No expiration`)
...
6. Create a folder to store the repository. (e.g. `remote-blog/`).
